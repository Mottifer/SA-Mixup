...
for i in tqdm(range(args.step)):
    ...
    # 用于 Mixup 之后的训练
    model_sa_ixup = load_model(args, dataset.num_node_features, dataset.num_classes, args.hid_num,
    ...
    optimizer_sa_mixup = torch.optim.Adam(model_intra_mixup.parameters(), lr=args.lr_mixup,
    ...
    # 训练最终模型
    best_test_acc = train_model_pyg_dynamic_data(model_sa_mixup, optimizer_sa_mixup, x, edge_index, noise_y,
